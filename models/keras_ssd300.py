...
def ssd_300(image_size,
    ...
    base_model_output = base_model.get_layer('activation_1').output
    block13 = base_model.get_layer('expanded_conv_5_expand').output  # Shape: (38, 38, 120)
               
    fc6 = Conv2D(1024, (3, 3), dilation_rate=(6, 6), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='fc6')(base_model_output)
    ...
    block13_norm = L2Normalization(gamma_init=20, name='block13_norm')(block13)

    ### Build the convolutional predictor layers on top of the base network

    # We precidt `n_classes` confidence values for each box, hence the confidence predictors have depth `n_boxes * n_classes`
    # Output shape of the confidence layers: `(batch, height, width, n_boxes * n_classes)`
    block13_norm_mbox_conf = Conv2D(n_boxes[0] * n_classes, (3, 3), padding='same',kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='block13_norm_mbox_conf')(block13_norm)
    ...
    block13_norm_mbox_loc = Conv2D(n_boxes[0] * 4, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_3_norm_mbox_loc')(block13_norm)
    ...
    block13_norm_mbox_priorbox = AnchorBoxes(img_height, img_width, this_scale=scales[0], next_scale=scales[1], aspect_ratios=aspect_ratios[0],
                                             two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[0], this_offsets=offsets[0], clip_boxes=clip_boxes,
                                             variances=variances, coords=coords, normalize_coords=normalize_coords, name='conv4_3_norm_mbox_priorbox')(block13_norm_mbox_loc)
    ...
    block13_norm_mbox_conf_reshape = Reshape((-1, n_classes), name='conv4_3_norm_mbox_conf_reshape')(block13_norm_mbox_conf)
    ...
    block13_norm_mbox_loc_reshape = Reshape((-1, 4), name='conv4_3_norm_mbox_loc_reshape')(block13_norm_mbox_loc)
    ...
    block13_norm_mbox_priorbox_reshape = Reshape((-1, 8), name='conv4_3_norm_mbox_priorbox_reshape')(block13_norm_mbox_priorbox)
